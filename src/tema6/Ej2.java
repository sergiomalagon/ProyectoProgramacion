...
/*
DiseÃ±ar el juego de "acierta la contraseÃ±a"
...
caracteres de la contraseÃ±a a partir del 9 intento le mostraremos mayor o menos alfabeticamente
 */
public class Ej2 {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Intenta adivinar la contraseÃ±a que ha puesto tu compaÃ±ero");
            ...
            if (contraseña.equals(contraseñacompañero)) {
                ...
                if (intentos <= 3) {
                    ...
                    System.out.println("La contraseÃ±a que estas buscando tiene " + numerocaracteres + " caracteres ");
                    ...
                    System.out.println("Los dos ultimos catacteres de la contraseÃ±a son: " + ultimo2 + ultimo1);
                    System.out.println("Te recuerdo que la contraseÃ±a tiene " + numerocaracteres + " caracteres ");
                } else if (intentos > 9) {
                    System.out.println("Error4");
                    System.out.println("Esta es la ultima vez que te ayudo");
                    if (contraseña.compareTo(contraseñacompañero) < 0) {
                        System.out.println("La contraseÃ±a que buscas es menor");
                    } else if (contraseña.compareTo(contraseñacompañero) > 0) {
                        System.out.println("La contraseÃ±a que buscas es mayor");
                    }
